...
<CardGroup cols={2}>
  <Card title="Explore the AI Room Designer" icon="arrow-up-right" href="https://www.aihdstudio.com/p/ai-interior-style-generator.html" cta="View tool overview" arrow="true">
    Learn how the designer transforms a room and how to choose the right style direction.
  </Card>
  <Card title="Put these tips into practice" icon="wand-magic-sparkles" href="https://app.aihdstudio.com/features/ai-designer" cta="Try the tool" arrow="true">
    Upload a clear room photo and generate a more targeted redesign.
  </Card>
</CardGroup>
