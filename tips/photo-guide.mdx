...
<CardGroup cols={2}>
  <Card title="Explore the AI Room Designer" icon="arrow-up-right" href="https://www.aihdstudio.com/p/ai-interior-style-generator.html" cta="View tool overview" arrow="true">
    See how a strong source photo becomes a complete AI room redesign.
  </Card>
  <Card title="Use your room photo" icon="wand-magic-sparkles" href="https://app.aihdstudio.com/features/ai-designer" cta="Try the tool" arrow="true">
    Upload the photo you prepared and preview a new interior style.
  </Card>
</CardGroup>
