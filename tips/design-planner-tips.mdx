...
<CardGroup cols={2}>
  <Card title="Explore the free Design Planner" icon="arrow-up-right" href="https://www.aihdstudio.com/p/free-ai-interior-design-consultant.html" cta="View tool overview" arrow="true">
    Learn how the AI consultant creates a useful brief before you generate designs.
  </Card>
  <Card title="Start your Design Plan" icon="wand-magic-sparkles" href="https://app.aihdstudio.com/plan" cta="Try the tool" arrow="true">
    Describe your room, priorities, budget, and constraints to build your brief.
  </Card>
</CardGroup>
