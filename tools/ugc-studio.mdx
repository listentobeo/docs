...
<CardGroup cols={2}>
  <Card title="Explore Design Content Studio" icon="arrow-up-right" href="https://www.aihdstudio.com/p/content-studio-designer-ai.html" cta="View tool overview" arrow="true">
    Learn how to turn a room into a podcast, gaming, video, office, or business setup.
  </Card>
  <Card title="Try Design Content Studio" icon="wand-magic-sparkles" href="https://app.aihdstudio.com/features/ugc-studio" cta="Try the tool" arrow="true">
    Upload your space and generate a content-ready studio concept in the app.
  </Card>
</CardGroup>
