...
<CardGroup cols={2}>
  <Card title="Explore the Wall Color Changer" icon="arrow-up-right" href="https://www.aihdstudio.com/p/wall-color-changer-online.html" cta="View tool overview" arrow="true">
    Learn how to test paint colors in your own room before buying paint.
  </Card>
  <Card title="Try the Wall Color Changer" icon="wand-magic-sparkles" href="https://app.aihdstudio.com/features/wall-color" cta="Try the tool" arrow="true">
    Upload a room photo and preview a new wall color in the app.
  </Card>
</CardGroup>
